...
$sql2 = "SELECT * FROM `tickets` WHERE `u_id` = '$tick_uid' AND `status` != 'completed' AND `status` != 'purged' AND `status` != 'pending'";
...
<h1>Tickets Assigned <?php echo substr($_SESSION["country_whole"],0,-7) ?></h1>
...
<tr>
<td width="8%">
<a href="#" onclick="window.open('reassign_ticket.php?ticket_id=<?php echo $faq2[$k]["tick_id"]; ?>&au_id=<?php echo $_SESSION["u_id"]; ?>','tickets2', 'width=350','height=250'); return false;" ><?php echo $faq2[$k]["tick_id"]; ?>
...
<td width="52%"><?php echo $faq2[$k]["data"]; ?></td>

<td width="10%">
<a href="#" onclick="window.open('ticket_status.php?ticket_id=<?php echo $faq2[$k]["tick_id"]; ?>','tickets2', 'width=350','height=250'); return false;" ><?php echo $faq2[$k]["status"]; ?>
</a>
</td>

<td width="10%"><?php echo $faq2[$k]["type"]; ?></td>
